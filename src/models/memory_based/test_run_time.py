...
print(model5.memory_based_recommender_combined(user_pred, 10, ratings, 5, movies))
print(model5.memory_based_recommender_combined(item_pred, 10, ratings, 5, movies))
